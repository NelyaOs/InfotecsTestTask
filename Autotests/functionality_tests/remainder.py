...
def test_rem_max_plus_1():
    assert request_status_code(ResponseEndpoints.remainder, 2147483648,
                               10) == ResponseStatusCode.large_value_error.value
...
def test_rem_min_minus_1():
    assert request_status_code(ResponseEndpoints.remainder, -2147483649,
                               10) == ResponseStatusCode.large_value_error.value
